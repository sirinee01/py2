 ...
 */
final class Version20260301195756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conversation (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE custom_meal_log (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, calories INT NOT NULL, protein INT DEFAULT NULL, carbs INT DEFAULT NULL, fat INT DEFAULT NULL, consumed_at DATETIME NOT NULL, meal_time VARCHAR(50) NOT NULL, reason LONGTEXT DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_6EEA06B5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE meal_consumption (id INT AUTO_INCREMENT NOT NULL, consumed_at DATETIME NOT NULL, completed TINYINT(1) NOT NULL, servings INT DEFAULT NULL, user_id INT NOT NULL, meal_id INT NOT NULL, INDEX IDX_21052B71A76ED395 (user_id), INDEX IDX_21052B71639666D6 (meal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, is_read TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, sender_id INT NOT NULL, conversation_id INT NOT NULL, INDEX IDX_B6BD307FF624B39D (sender_id), INDEX IDX_B6BD307F9AC0396 (conversation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE nutrition_plan (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, duration INT NOT NULL, objective LONGTEXT NOT NULL, created_at DATETIME NOT NULL, daily_water_intake INT DEFAULT NULL, target_calories INT DEFAULT NULL, target_protein INT DEFAULT NULL, target_carbs INT DEFAULT NULL, target_fat INT DEFAULT NULL, coach_id INT NOT NULL, INDEX IDX_F660B5EE3C105691 (coach_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE progress (id INT AUTO_INCREMENT NOT NULL, recorded_at DATETIME NOT NULL, weight DOUBLE PRECISION DEFAULT NULL, height DOUBLE PRECISION DEFAULT NULL, age INT DEFAULT NULL, body_fat_percentage DOUBLE PRECISION DEFAULT NULL, muscle_mass DOUBLE PRECISION DEFAULT NULL, daily_calorie_intake INT DEFAULT NULL, daily_water_intake DOUBLE PRECISION DEFAULT NULL, protein_intake INT DEFAULT NULL, carb_intake INT DEFAULT NULL, fat_intake INT DEFAULT NULL, activity_level VARCHAR(50) DEFAULT NULL, workouts_per_week INT DEFAULT NULL, primary_goal VARCHAR(50) DEFAULT NULL, target_weight DOUBLE PRECISION DEFAULT NULL, goal_timeline VARCHAR(20) DEFAULT NULL, dietary_restrictions LONGTEXT DEFAULT NULL, health_conditions LONGTEXT DEFAULT NULL, measurements JSON DEFAULT NULL, is_initial_onboarding TINYINT(1) NOT NULL, user_id INT NOT NULL, INDEX IDX_2201F246A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(100) NOT NULL, role_type VARCHAR(50) NOT NULL, gender VARCHAR(20) DEFAULT NULL, birth_date DATE DEFAULT NULL, onboarding_completed TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL, assigned_nutrition_plan_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649AD9AC3CA (assigned_nutrition_plan_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE water_intake (id INT AUTO_INCREMENT NOT NULL, amount DOUBLE PRECISION NOT NULL, consumed_at DATETIME NOT NULL, unit VARCHAR(50) DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_77832F8FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE custom_meal_log ADD CONSTRAINT FK_6EEA06B5A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        ...
        $this->addSql('ALTER TABLE meal_consumption ADD CONSTRAINT FK_21052B71A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE meal_consumption ADD CONSTRAINT FK_21052B71639666D6 FOREIGN KEY (meal_id) REFERENCES meal (id)');
        ...
        $this->addSql('ALTER TABLE water_intake ADD CONSTRAINT FK_77832F8FA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE custom_meal_log DROP FOREIGN KEY FK_6EEA06B5A76ED395');
        ...
        $this->addSql('ALTER TABLE meal_consumption DROP FOREIGN KEY FK_21052B71A76ED395');
        $this->addSql('ALTER TABLE meal_consumption DROP FOREIGN KEY FK_21052B71639666D6');
        ...
        $this->addSql('DROP TABLE custom_meal_log');
        $this->addSql('DROP TABLE meal');
        $this->addSql('DROP TABLE meal_nutrition_plan');
        $this->addSql('DROP TABLE meal_consumption');
